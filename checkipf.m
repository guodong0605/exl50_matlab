...
[itf,t]=exl50db(shotnum,'itf',datatime);
...
figure;set (gcf,'Position',[1,1,800,750],'WindowStyle','Normal'); % figure 1
stackplot({{t3,ip,'IP(kA)'},{t,itf,'ITF(kA)'},{t,ipf1,'IPF(A)'}}, [], [], [], ['Shot',num2str(shotnum)], 'Time (s)');
